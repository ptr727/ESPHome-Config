...
Building, flashing, and debugging a device outside the live ESPHome instance is documented in [OPERATIONS.md](./OPERATIONS.md#debugging): VSCode setup, the devcontainer, Windows, Windows WSL, and PlatformIO. The framework and platform version notes are in [the same file](./OPERATIONS.md#framework-and-platform-versions).
